...
function Switch({ checked, defaultChecked, onCheckedChange, ...props }: SwitchProps) {
  ...
  return (
    ...
    >
      <SwitchPrimitives.Root checked={isChecked} onCheckedChange={setIsChecked} {...props} asChild>
        <motion.button
          data-slot="switch"
          whileTap="tap"
          initial={false}
